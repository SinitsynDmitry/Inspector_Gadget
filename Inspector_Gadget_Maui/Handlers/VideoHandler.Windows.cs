...
using Inspector_Gadget_Maui.Platforms.Windows;

namespace Inspector_Gadget_Maui.Handlers
{
    public partial class VideoHandler : ViewHandler<Video, Inspector_Gadget_Maui.Platforms.Windows.MauiVideoPlayer>
    {
